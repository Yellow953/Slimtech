    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="d-flex justify-content-between">
                <h4 class="header-title my-auto">Purchases</h4>
                <a href="/purchases/new" class="btn btn-primary px-3 py-2 btn-custom text-dark">
                    ...
                    <div class="data-tables datatable-dark">
                        <table id="dataTable3" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr class="{{($purchase->status == 'completed') ? 'bg-light' : ''}}">
                                    <td>
                                        {{$purchase->id }} <br>
                                    </td>
                                    <td>Delivery Date</td>
                                    <td>
                                        {{ucfirst($purchase->user->name)}} <br>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <a href="/purchases/{{$purchase->id}}/complete"
                                            ...
                                            @endif
                                            <a href="/purchases/{{$purchase->id}}/show"
                                                class="btn btn-primary btn-custom text-dark p-2 m-1"><svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <form method="GET" action="/purchases/{{$purchase->id}}/destroy">
                                                @csrf
                                                <button type="submit"
